...
export const RISK_NEUTRALIZATIONS = [
...
export const NEUTRALIZATION_GROUPS = [
  {
    id: 'risk',
...
export const groupOf = (value) => (RISK_NEUTRALIZATIONS.includes(value) ? 'risk' : 'other')
/**
 ...
 */
export function splitNeutralizations(available) {
