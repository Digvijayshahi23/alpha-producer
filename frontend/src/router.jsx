...
const workbench = createRoute({
  getParentRoute: () => root,
  path: '/workbench',
  component: lazyRouteComponent(() => import('@/screens/workbench'), 'WorkbenchScreen'),
})
...
const journal = createRoute({
  getParentRoute: () => root,
  path: '/journal',
  component: lazyRouteComponent(() => import('@/screens/journal'), 'JournalScreen'),
})
const experiments = createRoute({
  getParentRoute: () => root,
  path: '/experiments',
  component: lazyRouteComponent(() => import('@/screens/experiments'), 'ExperimentsScreen'),
})
