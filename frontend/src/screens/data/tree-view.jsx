 ...
 */
export function DatasetTree({ source, counts, names, value, onChange }) {
  ...
  const hit = (id) => matches(id) || matches(nameOf(id))
  ...
  const isOpen = (key) => term !== '' || open.has(key)
...
function TreeRow({ depth, label, title, ids, chosen, count, open, onExpand, onToggle }) {
