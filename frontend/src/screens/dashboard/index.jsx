...
import { ErrorNotice, Page, Panel, QuotaGauge, Skeleton, TEXT_TONE } from '@/ui/kit'
...
function StatTile({ icon, label, action, value, hint, tone = 'neutral', loading, extra }) {
  return (
...
function ResetCountdown({ seconds, since }) {
