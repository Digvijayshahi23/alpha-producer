...
const LIMIT = 2000
const setting = (r, key) => String(r.settings?.[key] ?? '')
const market = (r) => setting(r, 'region') || DASH
...
export function TaskResultsScreen() {
  ...
  const ids = useMemo(() => rows.map((r) => r.alphaId).filter((a) => Boolean(a)), [rows])
