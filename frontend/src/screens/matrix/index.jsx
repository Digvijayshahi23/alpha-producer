...
import { blockLabel, coreBlocks } from '@/lib/matrix'
...
function SimulationMatrix() {
  ...
  const cancel = useMutation({
    ...
    mutationFn: (row) => simulations.cancel(row.id),
...
function CoreRow({ block, maxBatch, onCancel, roving, firstCell }) {
...
function MatrixCell({ cell, holder, at, roving }) {
  const className = cn(
