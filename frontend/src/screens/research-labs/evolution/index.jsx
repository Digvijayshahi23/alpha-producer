...
import { evolutionLab } from '@/screens/research-labs/evolution/api'
...
const marketKey = (region, delay, universe) => `${region}:${delay}:${universe}`
export function EvolutionLabScreen() {
  ...
  const preview = useQuery({
    ...
    queryFn: () => evolutionLab.preview(JSON.parse(settledKey)),
  ...
  const add = useMutation({
    mutationFn: (count) => evolutionLab.addTask({ ...body, simulations: count }),
    onSuccess: () => {
