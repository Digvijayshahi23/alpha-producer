 ...
 */
import { BaselineSeries, ColorType, createChart, LineSeries, LineStyle } from 'lightweight-charts'
 ...
 */
export const color = (name, alpha = 1) => {
 ...
 */
export function PnlChart({ values, dates, className, label = 'Cumulative PnL', compact }) {
  ...
  useEffect(() => {
    ...
    const chart = createChart(node, {
      ...
      timeScale: {
        ...
        minBarSpacing: 0.01,
        ...(times ? {} : { tickMarkFormatter: (t) => String(t) }),
      },
      localization: {
        ...(times
          ? {}
          : {
              timeFormatter: (t) => `Day ${Number(t).toLocaleString('en-US')}`,
            }),
