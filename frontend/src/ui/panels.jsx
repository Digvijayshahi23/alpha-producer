 ...
 */
export function ResizeHandle({ variant = 'gutter' }) {
...
export function SplitPane({ id, first, second, children, className }) {
...
function Split({ id, first, second, children, className }) {
  const [a, b] = Children.toArray(children)
